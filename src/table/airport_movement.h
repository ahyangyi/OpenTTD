...
static const AirportFTAbuildup _airport_fta_country[] = {
	{ 0, HANGAR, 0, 0, 1 },{ 0, TAKEOFF, RUNW01_block, 0, 1 },{ 0, 0, 0, 0, 1 },{ 0, HELITAKEOFF, 0, 0, 1 },{ 0, TERM01, 0, 0, 1 },{ 0, TERM02, 0, 0, 1 },{ 0, TERM03, 0, 0, 1 },
	{ 1,    255, RUNW01_block | HANG01_block, 0, 0 },{ 1, HANGAR, 0, 0, 0 },{ 1, TERM01, 0, 0, 2 },{ 1, TERM02, RUNW01_block, 0, 15 },{ 1, TERM03, RUNW01_block, 0, 15 }, { 1, TAKEOFF, RUNW01_block, 0, 15 }, { 1, HELITAKEOFF, 0, 0, 19 },{ 1, 0, 0, 0, 15 },
	// Airplane Terminals
...
static const AirportFTAbuildup _airport_fta_commuter[] = {
	...
	{ 0, HANGAR, 0, 0, 1 },{ 0, TAKEOFF, 0, TAXI06_block, 1 },{ 0, 0, 0, 0, 1 },{ 0, TERM01, 0, 0, 1 },{ 0, TERM02, 0, 0, 1 },{ 0, TERM03, 0, 0, 1 },{ 0, CARG01, 0, 0, 1 },{ 0, CARG02, 0, 0, 1 },{ 0, HELI01, 0, 0, 1 },{ 0, HELI02, 0, 0, 1 },{ 0, HELITAKEOFF, 0, 0, 1 },{ 0, TAKEOFF, 0, 0, 1 },
	{ 1, 255, HANG01_block, 0, 0 },{ 1, HANGAR, 0, 0, 0 },{ 1, TAKEOFF, 0, TAXI06_block, 25 },{ 1, TERM01, 0, TAXI05_block, 24 },{ 1, TERM02, 0, TAXI05_block | TAXI04_block, 24 },{ 1, TERM03, 0, TAXI05_block | TAXI04_block | TAXI03_block, 24 },{ 1, CARG01, 0, TAXI05_block, 24 },{ 1, CARG02, 0, TAXI05_block | TAXI04_block, 24 },{ 1, HELI01, 0, TAXI05_block, 24 },{ 1, HELI02, 0, TAXI05_block | TAXI04_block, 24 },{ 1, HELITAKEOFF, 0, 0, 36 },{ 1, 0, 0, 0, 0 },
	// Airplane Terminals
...
static const AirportFTAbuildup _airport_fta_cargol[] = {
	...
	{ 1, HANGAR, 0, 0, 1 },{ 1, TAKEOFF, 0, TAXI08_block, 3 },{ 1, 0, 0, 0, 3 },{ 1, CARG04, 0, 0, 3 },{ 1, CARG08, 0, 0, 3 },{ 1, CARG03, 0, 0, 3 },{ 1, CARG07, 0, 0, 3 },{ 1, CARG02, 0, 0, 3 },{ 1, HELI04, 0, 0, 3 },{ 1, HELI08, 0, 0, 3 },{ 1, HELI03, 0, 0, 3 },{ 1, HELI07, 0, 0, 3 },{ 1, HELI02, 0, 0, 3 },
...
static const AirportFTAbuildup _airport_fta_commuterl[] = {
	...
	{ 1, HANGAR, 0, 0, 3 },{ 1, TAKEOFF, 0, TAXI09_block, 3 },{ 1, 0, 0, 0,  3 },{ 1, TERM04, 0, 0, 3 },{ 1, TERM05, 0, 0, 3 },{ 1, TERM06, 0, 0, 3 },{ 1, CARG02, 0, 0, 3 },{ 1, HELI02, 0, 0, 3 },
	{ 2,    255, HANG01_block, 0, 0 },{ 2, HANGAR, 0, 0, 0 },{ 2, HELITAKEOFF, 0, 0, 44 },{ 2, 0, 0, 0, 27 },
	{ 3,    255, HANG02_block, 0, 0 },{ 3, HANGAR, 0, 0, 1 },{ 3, HELITAKEOFF, 0, 0, 45 },{ 3, TERM04, 0, TAXI06_block | TAXI07_block | TAXI08_block, 32 },{ 3, TERM05, 0, TAXI07_block | TAXI08_block, 32 },{ 3, TERM06, 0, TAXI08_block, 32 },{ 3, CARG02, 0, TAXI06_block | TAXI07_block | TAXI08_block, 32 },{ 3, HELI02, 0, TAXI06_block | TAXI07_block | TAXI08_block, 32 }, { 3, TAKEOFF, 0, TAXI09_block, 33 }, { 3, 0, 0, 0, 32 },
...
static const AirportFTAbuildup _airport_fta_indianapolis[] = {
	// Airplane & Helicopter Hangars
	{ 0, HANGAR, 0, 0, 4 },{ 0, TAKEOFF, 0, TAXI24_block, 4 },{ 0, 0, 0, 0, 4 },{ 0, TERM06, 0, 0, 4 },{ 0, TERM07, 0, 0, 4 },{ 0, TERM08, 0, 0, 4 },{ 0, TERM19, 0, 0, 4 },{ 0, TERM18, 0, 0, 4 },{ 0, TERM09, 0, 0, 4 },{ 0, TERM17, 0, 0, 4 },{ 0, TERM10, 0, 0, 4 },{ 0, TERM16, 0, 0, 4 },{ 0, TERM11, 0, 0, 4 },{ 0, TERM15, 0, 0, 4 },{ 0, TERM12, 0, 0, 4 },{ 0, TERM14, 0, 0, 4 },{ 0, TERM13, 0, 0, 4 },{ 0, CARG05, 0, 0, 4 },{ 0, CARG06, 0, 0, 4 },{ 0, CARG04, 0, 0, 4 },{ 0, HELI04, 0, 0, 4 },{ 0, HELI03, 0, 0, 4 },
	{ 1, HANGAR, 0, 0, 5 },{ 1, TAKEOFF, 0, TAXI38_block, 5 },{ 1, 0, 0, 0, 5 },{ 1, TERM21, 0, 0, 5 },{ 1, TERM20, 0, 0, 5 },{ 1, TERM19, 0, 0, 5 },{ 1, TERM08, 0, 0, 5 },{ 1, TERM18, 0, 0, 5 },{ 1, TERM09, 0, 0, 5 },{ 1, TERM17, 0, 0, 5 },{ 1, TERM10, 0, 0, 5 },{ 1, TERM16, 0, 0, 5 },{ 1, TERM11, 0, 0, 5 },{ 1, TERM15, 0, 0, 5 },{ 1, TERM12, 0, 0, 5 },{ 1, TERM14, 0, 0, 5 },{ 1, TERM13, 0, 0, 5 },{ 1, CARG02, 0, 0, 5 },{ 1, CARG01, 0, 0, 5 },{ 1, CARG03, 0, 0, 5 },{ 1, HELI03, 0, 0, 5 },
	...
	{ 4, 255, HANG01_block, 0, 0 },{ 4, HANGAR, 0, 0, 0 },{ 4, TERM06, 0, TAXI02_block | TAXI23_block, 63 },{ 4, TERM07, 0, TAXI02_block | TAXI03_block | TAXI22_block, 63 },{ 4, TERM08, 0, TAXI02_block | TAXI03_block | TAXI04_block | TAXI21_block, 63 },{ 4, TERM09, 0, TAXI18_block, 63 },{ 4, TERM10, 0, TAXI17_block, 63 },{ 4, TERM11, 0, TAXI16_block, 63 },{ 4, TERM12, 0, TAXI15_block, 63 },{ 4, TAKEOFF, 0, TAXI24_block, 85 },{ 4, HELITAKEOFF, 0, 0, 123 },{ 4, 0, 0, 0, 63 },
	{ 5, 255, HANG02_block, 0, 0 },{ 5, HANGAR, 0, 0, 1 },{ 5, TERM21, 0, TAXI32_block | TAXI37_block, 93 },{ 5, TERM20, 0, TAXI32_block | TAXI33_block | TAXI36_block, 93 },{ 5, TERM19, 0, TAXI32_block | TAXI33_block | TAXI34_block | TAXI35_block, 93 },{ 5, TERM09, 0, TAXI18_block, 93 },{ 5, TERM10, 0, TAXI17_block, 93 },{ 5, TERM11, 0, TAXI16_block, 93 },{ 5, TERM12, 0, TAXI15_block, 93 },{ 5, TAKEOFF, 0, TAXI38_block, 99 },{ 5, HELITAKEOFF, 0, 0, 128 },{ 5, 0, 0, 0, 93 },
